...
class Handler:
    ...
    def HandleGETRequest(self, Request):
        ...
        try:
            ...
            return Response
                ...
                return PrepareHeader()._response_headers(temporaryResponse[0], temporaryResponse[1]) + temporaryResponse[1]
    ...
    def HandlePOSTRequest(self, Request):
        ...
        try:
            if Form == 'Register':
                temporaryResponse = self.Register_Handler(DictPostData['UserID'], DictPostData['UserEmail'], DictPostData['UserName'], DictPostData['UserPw'], is_valid_cookie)
            elif Form == 'Login':
    ...
    def Register_Handler(self,UserID,UserEmail,UserName,UserPw,is_valid_cookie):
        ...
        self.log(f"[ Register User ] ==> UUID : \033[96m{UserUID}\033[0m")
        self.HandleSaveDB()
    ...
    def Logout_Handler(self,session):
        if session is None:
